    ...
    <footer className="bg-foreground text-card py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="text-card/60 text-sm uppercase tracking-wide leading-relaxed">
              INDIA'S MIDNIGHT SNACK DESTINATION. SATISFYING LATE-NIGHT CRAVINGS SINCE 2024.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["ABOUT US", "MENU", "CAREERS", "BLOG"].map((l) => (
                <li key={l}>
                  <a href="#" className="text-card/60 hover:text-card text-sm transition-colors uppercase tracking-wide">
                    {l}
                  </a>
                </li>
              ))}
        ...
        <div className="border-t border-card/10 pt-8 text-center">
          <p className="text-card/40 text-sm uppercase tracking-wider">
            © 2024 CAFE12AM. ALL RIGHTS RESERVED.
          </p>
        </div>
      </div>
    </footer>
